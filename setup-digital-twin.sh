...
source_cmd=/home/pib/ros2_pib_sim_ws/install/setup.bash
...
Einrichten ROS pib sim Workspace
mkdir -p ~/ros2_pib_sim_ws/src

cd ~/ros2_pib_sim_ws/src
...
####
wget https://pib.rocks/wp-content/uploads/pib_data/pib_sim.zip
